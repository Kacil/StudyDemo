package com.zxk.demossocore.path.impl;


import com.zxk.demossocore.path.PathMatcher;
import com.zxk.demossocore.util.StringUtils;
...
public class AntPathMatcher implements PathMatcher {
	 ...
	 * a list so that more specific patterns (without uri static or wild cards) come before
