...
public class RsaUtils {
     ...
     * @throws Exception
     */
    public static String sign(String privateKeyBase64, String data, String signAlgorithm) {
        try {
     ...
     * @throws Exception
     */
    public static boolean verify(String publicKeyBase64, String data, String sign, String signAlgorithm) {
        try {
